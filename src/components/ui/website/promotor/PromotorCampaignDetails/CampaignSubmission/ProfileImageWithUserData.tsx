                ...
                <div className=" p-6 relative border border-gray-200">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-shrink-0 md:mx-0 mx-auto">
                            <Image src={`${user?.image ? imageUrl + user?.image : '/placeholder.png'}`} alt="profile" width={120} height={120} className="h-28 md:h-20 w-28 md:w-20 object-cover rounded-md md:rounded-full md:mb-4" />
